...
# database 설정파일
app.config["SQLALCHEMY_DATABASE_URI"] = "mysql+pymysql://mome_admin:mome123!@#@13.209.171.180:3306/testdb"
	...
	if request.method=='GET':
		...
		try:
			...
			if data is not None:	# 쿼리 데이터가 존재하면
				...
				return 'can\'t Login'	# 쿼리 데이터가 없으면 출력
		except:
			return "CANT login"	# 예외 상황 발생 시 출력
